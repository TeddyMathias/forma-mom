      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-16">
        <div className="grid md:grid-cols-12 gap-12 mb-16">
          ...
          <div className="md:col-span-5">
            <h3 className="font-serif text-2xl tracking-[0.08em] text-cream mb-4">
              forma
            </h3>
          ...
          <div className="md:col-span-3">
            <h4 className="text-[11px] tracking-[0.2em] uppercase text-cream/30 mb-6">
              Navigate
            </h4>
        ...
        <div className="border-t border-cream/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6">
            <a href="#" className="text-cream/20 hover:text-cream/40 text-xs transition-colors">
              Privacy Policy
            </a>
            <a href="#" className="text-cream/20 hover:text-cream/40 text-xs transition-colors">
              Terms
