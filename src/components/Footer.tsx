      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="grid md:grid-cols-12 gap-10 mb-14">
          ...
          <div className="md:col-span-3 scroll-reveal rv-up rv-d2">
            ...
            <ul className="space-y-2.5 text-cream/35 text-[13.5px] font-light">
              <li>
                <a href="mailto:hello@matre.mom" className="hover:text-cream/70 transition-colors">
                  hello@matre.mom
                </a>
              </li>
              <li>New York City</li>
            ...
            {/* TODO: Uncomment when social accounts are ready
            <div className="flex gap-3 mt-5">
              <a href="https://www.instagram.com/matre.mom" target="_blank" rel="noopener noreferrer" className="text-cream/20 hover:text-cream/50 transition-colors" aria-label="Instagram">
              ...
              <a href="https://www.tiktok.com/@matre.mom" target="_blank" rel="noopener noreferrer" className="text-cream/20 hover:text-cream/50 transition-colors" aria-label="TikTok">
                <svg className="w-4.5 h-4.5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="pt-6 border-t border-cream/6 flex flex-col sm:flex-row items-center justify-between gap-3 scroll-reveal rv-up rv-d3">
          <p className="text-cream/15 text-[11px] tracking-wider font-light">
            &copy; {new Date().getFullYear()} Train with Lane. All rights reserved.
          </p>
          <div className="flex gap-5">
            <a href="/privacy" className="text-cream/15 hover:text-cream/30 text-[11px] transition-colors font-light">Privacy Policy</a>
            <a href="/terms" className="text-cream/15 hover:text-cream/30 text-[11px] transition-colors font-light">Terms</a>
          </div>
        </div>
      </div>
    </footer>
