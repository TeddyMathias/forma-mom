        ...
        <div className="grid md:grid-cols-12 gap-10 mb-14">
          ...
          <div className="md:col-span-3 scroll-reveal rv-up rv-d2">
            ...
            <div className="flex gap-3 mt-5">
              <a href="https://www.instagram.com/forma.mom" target="_blank" rel="noopener noreferrer" className="text-cream/20 hover:text-cream/50 transition-colors" aria-label="Instagram">
              ...
              <a href="https://www.tiktok.com/@forma.mom" target="_blank" rel="noopener noreferrer" className="text-cream/20 hover:text-cream/50 transition-colors" aria-label="TikTok">
                <svg className="w-4.5 h-4.5" fill="currentColor" viewBox="0 0 24 24">
